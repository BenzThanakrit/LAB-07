...
time	|ใช่ไม่ได้ |	เป็นคำสงวนในภาษา C#		
do	| ใช่ไม่ได้ |	เป็นคำสงวนในภาษาc#		
Do	|ใช่ไม่ได้  |	เป็นคำสงวนในภาษา C#		
21November	|ใช่ไม่ได้ |	มีตัวเลข		
ladkrabang	| ใช้ได้|			
Student ID	|ช่ไม่ได้ |	เว้นวรรค		
...
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.1.PNG?raw=true)
...
6. Exclusive OR
```
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.2.PNG?raw=true)
...
10.	100*x+y%2-a
```
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.3.PNG?raw=true)
...
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.5.PNG?raw=true)
##คลาส Math 
...
3.	y = tan(x)
```
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.6.PNG?raw=true)	
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.7.PNG?raw=true)
![](https://github.com/BenzThanakrit/LAB-07/blob/master/7.8.PNG?raw=true)
